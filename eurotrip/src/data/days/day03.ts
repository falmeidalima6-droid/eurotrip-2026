...
export const day03: DiaRoteiro = {
  ...
  eventos: [
    ...
    },
    {
      ...
      confirmado: false,
      prioridade: "alta",
      endereco: "Prefettura della Casa Pontificia, Portão de Bronze, Vaticano",
      observacoes: "Solicitação nº 708373 (2 bilhetes) já aprovada. Falta só passar na Prefeitura pra pegar o comprovante físico antes da audiência de amanhã. ⚠️ Confirmar o horário exato de retirada no e-mail de confirmação ou no site — costuma ser na tarde/início da noite da véspera. Como o hotel fica perto do Vaticano, dá pra encaixar rapidinho entre o retorno ao hotel e o jantar de aniversário.",
    },
    {
      id: "d03-e13",
      data: "2026-10-06",
