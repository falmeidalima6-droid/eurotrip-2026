...
export const day12: DiaRoteiro = {
  ...
  eventos: [
    ...
    },
    {
      ...
      status: "futuro",
      confirmado: true,
      observacoes: "Com bagagem, transporte direto (não transporte público). Meta: chegar ao aeroporto por volta de 09h30–09h45. 🚕 Táxi/Uber/Bolt, mesma faixa da ida: ~€26-45 até o Aeroporto El Prat (taxímetro, sem tarifa fixa). 💰 Bolt costuma sair 10-25% mais barato em Barcelona.",
    },
    {
      id: "d12-e04",
      data: "2026-10-15",
