...
export const day09: DiaRoteiro = {
  ...
  eventos: [
    ...
    },
    {
      ...
      status: "futuro",
      confirmado: true,
      observacoes: "Entrada gratuita. Substitui Sainte-Chapelle como roteiro principal (Sainte-Chapelle fica como alternativa). ⚠️ CORREÇÃO: a Coroa de Espinhos NÃO fica exposta o tempo todo — só na 1ª sexta-feira de cada mês, às 15h, e na Sexta-feira Santa. Como 12/10 é segunda-feira, ela não estará visível — não vale a pena pagar o Tesouro (€12) só por isso.",
      dicaMetro:
