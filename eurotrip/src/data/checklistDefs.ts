...
export const checklistDefs: ChecklistDef[] = [
  ...
  },
  {
    ...
    itens: [
      ...
      "Itens pessoais",
      "Cadeado de porte e de mala",
      "Cabo de aço para mala",
      "Confirmar peso: 23kg despachada + 10kg cabine (por pessoa)",
    ],
  },
  {
    categoria: "✈️ Conforto de Viagem/Voo",
    itens: [
      "Suporte de cabeça e de pé",
      "Meia de compressão",
      "Spray passa roupas",
      "Fone de ouvido (voo/dormir)",
    ],
  },
  {
    categoria: "Roupas",
